...
sudo scutil --set ComputerName "ernest-mbp0xe0x7e8"
sudo scutil --set HostName "ernest-mbp0xe0x7e8"
sudo scutil --set LocalHostName "ernest-mbp0xe0x7e8"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "ernest-mbp0xe0x7e8"
...
defaults write NSGlobalDomain AppleLanguages -array "en-TW" "zh-Hant-TW" "zh-Hant"
defaults write NSGlobalDomain AppleLocale -string "en_TW@currency=USD"
...
#   - `pmset -g custom`
# 
#   - `pmset -a`: a stnads for All
#   - `pmset -b`: b stands for Battery
#   - `pmset -c`: c stands for Charger (wall power)
#
...
# Set machine sleep to N minutes on battery
sudo pmset -b sleep 5

# Set standby delay high to 24 hours
